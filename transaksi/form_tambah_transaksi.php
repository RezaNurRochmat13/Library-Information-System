                  ...
                  <div class="x_content">
                        <form action="proses_tambah_transaksi.php" method="POST">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="kode_anggota" required>
                                      <?php
                              ...
                              ?>
                                  <option value="<?php echo $kode_anggota;?>"><?php echo $nama_anggota;?></option>
                                    <?php }?>
                              </select>
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="kode_petugas" required>
                                 <?php
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="kode_buku">
                                ...
                                <?php
                                  $sqlku="SELECT * FROM buku";
                                  $result = mysqli_query($db,$sqlku);
                                ...
                                ?>
                                  ...
                                  <option value="<?php echo $kode_buku;?>"><?php echo $judul_buku;?></option>
                                <?php }?>
                              </select>
                            ...
                            <div class="form-group">
                              ...
                              <label for="formGroupExampleInput2">Nama Buku</label>
                              <select class="form-control" name="kode_buku2">
                                   <option>Pilih Buku</option>
                                <?php
                                  $sqlku="SELECT * FROM buku";
                                  $result = mysqli_query($db,$sqlku);
                            ...
                            <div class="form-group">
                              ...
                              <input type="date" name="tanggal_pinjam" class="form-control" id="formGroupExampleInput2" required>
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Tanggal Kembali</label>
                              <input type="date" name="tanggal_kembali" class="form-control" id="formGroupExampleInput2" required>
                            </div>
                              <button type="submit" class="btn btn-primary">Submit</button>
                               <a href="daftaranggota.php" onclick="return confirm('Anda yakin akan meninggakan proses ini?')" class="btn btn-danger">Cancel</a>
                      </form>
                  </div>
                </div>
              </div>
