          ...
          <div class="">
            <div class="page-title">
              <div class="title_center">
                <h3 align="center">SISTEM PERPUSTAKAAN</h1>
                <h3 align="center">SMK YPBI MARTAPURA</h1>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                     ...
                     <div class="profile_img">
                      ...
                      <h3><?php echo $nama_petugas;?></h3>

                      <ul class="list-unstyled user_data">

                        <li class="m-top-xs">
                          <i class="fa fa-user"> Username: </i><?php echo $username;?>
                        </li>
                      </ul>
                      <?php }?>

                      <a href ="form_edit_profile.php?kode_petugas=<?php echo $kode_petugas;?>" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                      <br />
                    </div>
                  </div>
                </div>
