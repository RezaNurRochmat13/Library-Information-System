                  ...
                  <div class="x_content">
                        <form action="proses_tambah_buku.php" method="POST">
                            <div class="form-group">
                              ...
                              <input type="text" name="judul_buku" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan nama buku" required>
                            </div>
                            <div class="form-group">
                            <label for="formGroupExampleInput">Penulis Buku</label>
                            <input type="text" name="penulis_buku" class="form-control" id="formGroupExampleInput" placeholder="Masukkan penulis buku" required>
                          </div>
                          <div class="form-group">
                            <label for="formGroupExampleInput">Penerbit Buku</label>
                            <input type="text" name="penerbit_buku" class="form-control" id="formGroupExampleInput" placeholder="Masukkan penerbit buku" required>
                          </div>
                          <div class="form-group">
                            <label for="formGroupExampleInput">Katagori Buku</label>
                            <input type="text" name="katagori_buku" class="form-control" id="formGroupExampleInput" placeholder="Masukkan Katagori Buku buku" required>
                          </div>
