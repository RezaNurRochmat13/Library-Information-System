            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="daftarbuku.php"><i class="fa fa-book"></i> Daftar Buku </a>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                          $buku = "SELECT COUNT(judul_buku) AS stok,kode_buku, 
                          judul_buku, penulis_buku, penerbit_buku, katagori_buku FROM buku
                        ...
                        <tr>
                          ...
                          <td><?php echo $katagori_buku;?></td>
                          <td><?php echo $stok;?></td>
                          <td><img src="https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=<?php echo $judul_buku?>&choe=UTF-8"/></td>

                          <td>
                            <a href="form_tambah_buku.php" class="btn btn-success">Tambah</a>
                            <a href="form_edit_buku.php?kode_buku=<?php echo $kode_buku;?>" class="btn btn-info">Edit</a>
                            <a href="delete_buku.php?kode_buku=<?php echo $kode_buku;?>" class="btn btn-danger" onclick="return confirm('Anda yakin menghapus data ini?')">Hapus</a>
                          </td>
                        </tr>
                        <?php }?>
