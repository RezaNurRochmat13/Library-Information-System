                  ...
                  <div class="x_content">
                    <?php
                      ...
                      while($row = mysqli_fetch_array($result)){
                        ...
                        $katagori_buku = $row['katagori_buku'];


                    ?>
                        <form action="update_buku.php?kode_buku=<?php echo $kode_buku;?>" method="POST">
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Nama Buku</label>
                               <input type="hidden" name="kode_buku" class="form-control" id="formGroupExampleInput2" value="<?php echo $kode_buku;?>">
                              <input type="text" name="judul_buku" class="form-control" id="formGroupExampleInput2" value="<?php echo $judul_buku;?>">
                            </div>
                            <div class="form-group">
                            <label for="formGroupExampleInput">Penulis Buku</label>
                            <input type="text" name="penulis_buku" class="form-control" id="formGroupExampleInput" value="<?php echo $penulis_buku;?>">
                          </div>
                          <div class="form-group">
                            <label for="formGroupExampleInput">Penerbit Buku</label>
                            <input type="text" name="penerbit_buku" class="form-control" id="formGroupExampleInput" value="<?php echo $penerbit_buku;?>">
                          </div>
                          <div class="form-group">
                            <label for="formGroupExampleInput">Katagori Buku</label>
                            <input type="text" name="katagori_buku" class="form-control" id="formGroupExampleInput" value="<?php echo $katagori_buku;?>">
                          </div>
                              <button type="submit" class="btn btn-primary">Submit</button>
                               <a href="daftarbuku.php" onclick="return confirm('Anda yakin meninggalkan proses ini?')" class="btn btn-danger">Cancel</a>
                      </form>
                      <?php }?>
                  </div>
                </div>
