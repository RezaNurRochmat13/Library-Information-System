                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                          $daftaranggota = "SELECT * FROM anggota";
                          $result = mysqli_query($db,$daftaranggota);
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="form_tambah_anggota.php" class="btn btn-success">Tambah</a>
                            <a href="form_edit_anggota.php?kode_anggota=<?php echo $kode_anggota;?>" class="btn btn-info">Edit</a>
                            <a href="delete_anggota.php?kode_anggota=<?php echo $kode_anggota;?>" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                          </td>
                        </tr>
                        <?php }?>
