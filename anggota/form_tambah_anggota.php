                  ...
                  <div class="x_content">
                        <form action="proses_tambah_anggota.php" method="POST">
                            <div class="form-group">
                              ...
                              <input type="text" name="nama_anggota" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan Nama Anggota" required>
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Alamat Anggota</label>
                              <input type="text" name="alamat_anggota" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan Alamat Anggota" required>
                            </div>
                              <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="kelas" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan Kelas Anggota" required>
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">No Tlp</label>
                              <input type="text" name="no_tlp" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan No Tlp Anggota" required>
                            </div>
                          <div class="form-group">
